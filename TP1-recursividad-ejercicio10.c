#include <stdio.h>
#include <stdbool.h>
#include "D:\universidad\estructura de datos y algoritmos 1\TP1 - recursividad\listas_arreglos.c"
#include "D:\universidad\estructura de datos y algoritmos 1\TP1 - recursividad\tipo_elemento.c"
...
int* explotar(int N, int B, int* cantidad) {
    ...
    int cant1, cant2;
    int* parte1 = explotar((N - N%B)/B, B, &cant1);
    int* parte2 = explotar(N- ((N - N%B)/B), B, &cant2);
